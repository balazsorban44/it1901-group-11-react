...
const EventInfo = ({staff, event: {from, to, location, name}}) => {
  return (
    <div>
      <h4><FontIcon style={{color: "grey"}} className="material-icons">info</FontIcon></h4>
...
const Dates = ({from, to}) => (
  <div>
    <FontIcon style={{color: "grey"}} className="material-icons">event</FontIcon>
...
const Location = ({location}) => (
  <div>
    <FontIcon style={{color: "grey"}} className="material-icons">map</FontIcon>
    <p>{location}</p>
  </div>
)
...
const StaffList = ({staff}) => {
  ...
  return (
    <div>
      <h5><FontIcon style={{color: "grey"}} className="material-icons">people</FontIcon></h5>
